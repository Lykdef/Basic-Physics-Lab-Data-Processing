...
const columnSchema = z.object({ id: z.string().min(1), name: z.string().min(1), symbol: z.string().regex(/^[A-Za-z][A-Za-z0-9_]*$/), display_symbol: z.string().max(80).optional(), unit: z.string(), precision: z.number().int().min(0).max(8) });
